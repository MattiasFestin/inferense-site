									...
									<div className="tile">
										<div className="tile is-parent is-vertical">
											<article className="tile is-child">
												...
												<img alt="data" loading="lazy" src="/img/svg/undraw_financial_data_es63.svg" />
											</article>
										</div>
										<div className="tile is-parent">
											<article className="tile is-child">
												{/* <PreviewCompatibleImage imageInfo={main.image2} /> */}
												<img alt="process" loading="lazy" src="/img/svg/undraw_prototyping_process_rswj.svg" />
											</article>
										</div>
									</div>
									<div className="tile is-parent">
										<article className="tile is-child">
											<img alt="analytics" loading="lazy" src="/img/svg/undraw_setup_analytics_8qkl.svg" />
										</article>
									</div>
								</div>
							</div>
